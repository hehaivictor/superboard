...
def build_preview_payload(material: str, mode_id: str, material_pack: object) -> dict[str, object]:
    ...
    return {
        ...
        "persona_graph_refs": record.get("persona_graph_refs", []),
        "model_comparisons": record.get("model_comparisons", []),
        "action_audit": record.get("action_audit", []),
        "governance_checks": record.get("governance_checks", []),
